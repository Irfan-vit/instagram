  ...
  <div id="app">
    <div style="display: flex; flex-direction: column;">
      ...
      <div id="upload">
        ...
        <img style="padding:2rem" src="vit5.jpeg" alt="VELLORE INSTITUTE OF TECHNOLOGY">
        <h6>Made by</h6>
        <h5 style="color:white,font-family:sans-serif">Irfan : 19BCE0780 and Suhail : 19BCE0226</h5>
          <h2>Post Here!</h2>
